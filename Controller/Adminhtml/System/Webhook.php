...
namespace Cyclr\Webhook\Controller\Adminhtml\System;
...
class Webhook extends Action
{
    ...
    protected function createPage()
    {
        ...
        $resultPage->setActiveMenu('Cyclr_Webhook::system_webhook')
    ...
    protected function _initWebhook()
    {
        ...
        /* @var $webhook \Cyclr\Webhook\Model\Webhook */
        $webhook = $this->_objectManager->create('Cyclr\Webhook\Model\Webhook');
        if ($webhookId) {
    ...
    {
        return $this->_authorization->isAllowed('Cyclr_Webhook::webhook');
    }
}
